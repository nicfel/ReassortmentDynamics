...
system(paste("/Applications/BEAST\\ 2.7.7/bin/logcombiner ","-burnin 20 -log ./out3/HPAI_HLHxNx.glm.rep*.trees -o ./combined/HPAI_HLHxNx.glm.trees"))
...
system(paste("/Applications/BEAST\\ 2.7.7/bin/logcombiner -burnin 20 -log ./out3/HPAI_HLHxNx.glm.rep*.log -o ./combined/HPAI_HLHxNx.glm.log"))
