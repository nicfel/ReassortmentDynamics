...
def loadNexusMRSI(tree_path,tip_regex='\|([0-9]+\-[0-9]+\-[0-9]+)',date_fmt='%Y-%m-%d',treestring_regex='tree [A-Za-z\_]+([0-9]+)',variableDate=True,absoluteTime=True,verbose=False,mostRecentSample="", sortBranches=True):
    tipFlag=False
    tips={}
    tipNum=0
    ll=None
